...
public class TemplatePass : ScriptableRenderPass
{
    ...
    public TemplatePass(TemplateFeature.PassSettings passSettings)
    {
        ...
        if(passSettings.material == null) passSettings.material = CoreUtils.CreateEngineMaterial("Hidden/PixelateShader");
    }
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        using (new ProfilingScope(cmd, new ProfilingSampler(ProfilerTag)))
        {
            ...
            Blit(cmd, colorBuffer, colorBuffer, passSettings.material, 0); // shader pass 0
        }
